...
// OPTIMIZED: Fetch each category separately to maximize 200 credits/day limit
// 10 categories × 24 hours = 240 API calls/day (uses full quota)
// Each call returns ~10 articles = ~2,400 fresh articles/day
